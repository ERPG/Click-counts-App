...
const urlCarref = 'https://www.carrefour.es/global/?Dy=1&Nty=1&Ntt=[KEYWORD]&search='
const urlCI = 'https://www.elcorteingles.es/search/?s=[KEYWORD]'
const urlFnac = 'https://busqueda.fnac.es/SearchResult/ResultList.aspx?SCat=0%211&Search=[KEYWORD]&sft=1&sa=0'
const urlSolo = 'https://www.solostocks.com/venta-productos/[KEYWORD]_b'
